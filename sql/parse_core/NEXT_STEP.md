# Parse Core Next Step

## Overview

The parse-core split SQL surface has now been:
...
Parse-core split SQL yüzeyi artık:
...
Future parse-core SQL evolution should start from:
...
Gelecekteki parse-core SQL evrimi şu dosyalardan başlamalıdır:
...
1. controlled semantic evolution of one parse split SQL file
2. a new parse-core package added in chronology order
...
1. parse split SQL dosyalarından birinde kontrollü semantik evrim
2. chronology sırasına uygun yeni bir parse-core paketinin eklenmesi
