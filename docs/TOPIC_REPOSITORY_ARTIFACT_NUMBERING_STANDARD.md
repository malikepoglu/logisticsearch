...
<!-- BEGIN SECTION1_WEBCRAWLER_NAMING_RULE -->
...
- `docs/` altındaki kanonik crawler-özel dokümantasyon, belge konusu açıkça web crawler alanına aitse `SECTION1_WEBCRAWLER_...` önekini kullanmalıdır.
