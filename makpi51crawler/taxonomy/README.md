...
As of commit `831d5c0` (`feat(taxonomy): normalize canonical JSON model`), this taxonomy JSON surface intentionally contains 25 language JSON files under `makpi51crawler/taxonomy/languages/`.
...
`831d5c0` (`feat(taxonomy): normalize canonical JSON model`) commit'i itibarıyla bu taxonomy JSON yüzeyi bilinçli olarak `makpi51crawler/taxonomy/languages/` altında 25 dil JSON dosyası içerir.
