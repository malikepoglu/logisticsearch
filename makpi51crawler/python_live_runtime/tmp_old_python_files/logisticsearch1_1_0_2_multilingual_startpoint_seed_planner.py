...
# EN:   makpi51crawler project tree.
...
# TR:   Beklenen doğru değerler: .git ve beklenen makpi51crawler proje
...
def _repo_default() -> Path:
    """EN/TR: Infer repo root from this hierarchical python_live_runtime module path."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--catalog-root",
        default="makpi51crawler/catalog/startpoints",
    )
    parser.add_argument(
        "--taxonomy-language-dir",
        default="makpi51crawler/taxonomy/languages",
    )
