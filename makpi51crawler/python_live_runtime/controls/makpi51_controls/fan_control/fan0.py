#!/usr/bin/env python3
# EN: This file controls Pi51 fan0 mode through /etc/pi51c-fans/fan0.mode.
# TR: Bu dosya Pi51 fan0 modunu /etc/pi51c-fans/fan0.mode üzerinden yönetir.
...
MODE_PATH = Path("/etc/pi51c-fans/fan0.mode")
...
def main(argv: list[str]) -> int:
    ...
    if len(argv) != 1:
        print("usage: fan0.py auto|0-255", file=sys.stderr)
        show()
        return 2
    ...
    if value.isdigit() and 0 <= int(value) <= 255:
        ...
        print(f"fan0=manual value={value}")
        return 0
