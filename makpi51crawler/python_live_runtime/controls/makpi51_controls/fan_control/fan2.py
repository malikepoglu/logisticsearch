#!/usr/bin/env python3
# EN: This file controls Pi51 fan2 mode through /etc/pi51c-fans/fan2.mode.
# TR: Bu dosya Pi51 fan2 modunu /etc/pi51c-fans/fan2.mode üzerinden yönetir.
...
MODE_PATH = Path("/etc/pi51c-fans/fan2.mode")
...
def main(argv: list[str]) -> int:
    ...
    if len(argv) != 1:
        print("usage: fan2.py auto|0-255", file=sys.stderr)
        show()
        return 2
    ...
    if value.isdigit() and 0 <= int(value) <= 255:
        ...
        print(f"fan2=manual value={value}")
        return 0
